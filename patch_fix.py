...
# I will find the part from "    com.example.ui.components.PremiumDialog(" down to the end of the function, and replace it.

pattern = re.compile(r"    com\.example\.ui\.components\.PremiumDialog\(.*?^\}", re.MULTILINE | re.DOTALL)
